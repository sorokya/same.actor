export function Footer() {
  return (
    <footer class="w-full p-2 bg-slate-500 border-t border-slate-300 shadow md:flex md:items-center md:justify-between">
      <div class="text-sm text-slate-50 text-center md:text-left sm:w-full">© 2024 Richard Leek. All Rights Reserved.</div>
      <div class="flex flex-wrap items-center mt-3 text-center font-medium text-slate-50 sm:mt-0">
        <p className="text-xs">
