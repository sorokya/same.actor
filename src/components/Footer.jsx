export function Footer() {
  return (
    <footer class="fixed bottom-0 left-0 z-20 w-full p-4 bg-slate-500 border-t border-slate-300 shadow md:flex md:items-center md:justify-between md:p-6">
      <span class="text-sm text-slate-50 sm:text-center">© 2024 Richard Leek. All Rights Reserved.
      </span>
